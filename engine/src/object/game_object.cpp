...
{
  for (Component *comp : p_components) { (comp->*(&Component::Update))(); }
}

void GameObject::FixedUpdate()
{
  for (Component *comp : p_components) { (comp->*(&Component::FixedUpdate))(); }
}

void GameObject::ProcessInput()
{
  for (Component *comp : p_components) { (comp->*(&Component::ProcessInput))(); }
}
}// namespace Anterle
