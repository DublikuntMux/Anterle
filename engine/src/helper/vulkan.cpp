  ...
  VkPhysicalDevice physicalDevice)
{
  ...
  if (vkCreateBuffer(device, &bufferInfo, nullptr, &buffer) != VK_SUCCESS) { printf("failed to create buffer!"); }
  ...
  VkDevice device)
{
  ...
  endSingleTimeCommands(commandBuffer, graphicsQueu, device, commandPool);
}
